...
class TestValidRegistrationRT:
    ...
    def open(self):
        self.driver = webdriver.Chrome("C:\Users\Евгений\PycharmProjects\pythonProject\chromedriver-win64\chromedriver.exe")
...
# 12
    @allure.feature('Авторизация с неправильным Email')
...
# 13
    @allure.feature('Авторизация с неправильным номером телефона')
...
# 14
    @allure.feature('Авторизация с неправельным паролем')
